...
{
    private const URL_PATH_EDIT = 'ecommage_blogext3/blog/edit';
    private const URL_PATH_DELETE = 'ecommage_blogext3/blog/delete';
    ...
    {
        return $this->urlBuilder->getUrl(self::URL_PATH_EDIT, ['blog_id' => $item['id']]);
    }
